...
namespace ModBase.Configuration.Modules
{
  public class ModuleConfig : ConfigurationElement
  {
    ...
    public virtual Boolean IsPipe(Type instanceType = null, Type contentType = null)
    {
      ...
      if (Instance != null)
      {
        ...
        {
          if (interfaces[i].Name.Equals(typeof(IPipe<>).Name) || IsPipe(interfaces[i], contentType))
          {
            if (contentType == null)
              return true;
            else
    ...
    public virtual bool SetLonghandProperties()
    {
      bool result = true;
